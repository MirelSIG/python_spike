...
const promptHTML = '<span class="terminal-user">luis@python-dev</span>:<span class="terminal-path">~/proyecto</span>$ ';
let currentFile = './objetos-python/objetos_basicos.py';
...
async function ejecutarCodigo() {
    ...
    cmdSpan.innerHTML = promptHTML + 'python3 LuisPY/' + currentFile.replace('./', '');
